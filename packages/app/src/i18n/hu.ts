...
export const dict = {
  ...
  "command.session.unarchive": "Munkamenet visszaállítása az archívumból",
  "command.session.archivedBrowse": "Archivált munkamenetek böngészése",
