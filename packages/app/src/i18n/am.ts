export const dict = {
  ...
  "command.session.unarchive": "ክፍለ ጊዜን ከማህደር ውጣ",
  "command.session.archivedBrowse": "የተመዘገቡ ክፍለ ጊዜዎችን ያስሱ",
  ...
  "dialog.archivedSessions.title": "የተመዘገቡ ክፍለ ጊዜዎች",
  "dialog.archivedSessions.empty": "የተመዘገበ ክፍለ ጊዜ የለም",
