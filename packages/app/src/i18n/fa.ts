export const dict = {
  ...
  "command.session.unarchive": "خارج کردن جلسه از آرشیو",
  "command.session.archivedBrowse": "مرور جلسات آرشیو شده",
  ...
  "dialog.archivedSessions.title": "جلسات آرشیو شده",
  "dialog.archivedSessions.empty": "هیچ جلسه آرشیو شده‌ای وجود ندارد",
  ...
  "common.unarchive": "خارج کردن از آرشیو",
  "common.delete": "حذف",
  "common.close": "بستن",
