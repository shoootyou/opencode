export const dict = {
  ...
  "command.session.unarchive": "სესიის დეარქივება",
  "command.session.archivedBrowse": "დაარქივებული სესიების დათვალიერება",
  ...
  "dialog.archivedSessions.empty": "დაარქივებული სესია არ არის",
