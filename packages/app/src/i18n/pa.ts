export const dict = {
  ...
  "command.session.unarchive": "سیشن نوں آرکائیو توں کڈھو",
  "command.session.archivedBrowse": "آرکائیو کیتے سیشن ویکھو",
  ...
  "common.unarchive": "آرکائیو توں کڈھو",
  "common.delete": "مکاؤ",
