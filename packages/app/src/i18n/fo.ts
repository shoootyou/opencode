export const dict = {
  ...
  "command.session.unarchive": "Tak setu úr arkivi",
  "command.session.archivedBrowse": "Kaga ígjøgnum arkiveraðar setur",
  ...
  "common.unarchive": "Tak úr arkivi",
